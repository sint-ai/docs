...
| SDKs | 3 (TypeScript client, MCP bridge, CLI) |
| Test suite | 1,363 tests |
| Protocol bridges | 11 (ROS2, gRPC, MCP, MQTT/Sparkplug, OPC-UA, MAVLink, A2A, IoT, OpenRMF, Economy, Swarm) |
...
<Note>
  SINT Protocol is open-source under the MIT license. The gateway server and CLI are production-ready. Avatar system and Operators platform are in active development.
</Note>
